...
import com.scarecrow.root.orchardapp.activties.ActivityFruitMain;
import com.scarecrow.root.orchardapp.activties.ActivityHealthyMain;
import com.scarecrow.root.orchardapp.activties.ActivityOrchardExtendService;
import com.scarecrow.root.orchardapp.activties.ActivityOrchardMain;
...
public class FragmentGuideHome extends Fragment implements Button.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.home_img_button_fruit:
                Intent it = new Intent(getContext(), ActivityFruitMain.class);
                startActivity(it);
                break;
            case R.id.home_img_button_orchard:
                Log.d(TAG, "onClick: guangguoyuan");
                startActivity(new Intent(getContext(), ActivityOrchardMain.class));
                break;
