...
import com.scarecrow.root.orchardapp.activties.ActivityOrchardDetail;
...
public class AdapterSurrdPlace extends RecyclerView.Adapter<AdapterSurrdPlace.ViewHolder> {
    Context mContext;
    List<PlaceInfoSingle> mPlaces = new ArrayList<>();

    public AdapterSurrdPlace(Context context) {
        super();
        mContext = context;
    ...
    @Override
    public void onBindViewHolder(final AdapterSurrdPlace.ViewHolder holder, final int position) {
        ...
        holder.Item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in = new Intent(mContext, ActivityOrchardDetail.class);
