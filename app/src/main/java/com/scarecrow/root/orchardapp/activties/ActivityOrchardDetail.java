...
public class ActivityOrchardDetail extends AppCompatActivity {
    ...
    public void onCreate(Bundle onSaveInstanceState){
        ...
        new BannerLoader()
                .bannerPreparing
                        (bannernum, (ViewPagerAdsBanner) findViewById(R.id.orchard_single_banner), getBaseContext());
        ...
        ll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in = new Intent(getBaseContext(), ActivityOrchardInfo.class);
    ...
    public void onDestroy() {
        ...
        ViewPagerAdsBanner ab = (ViewPagerAdsBanner) findViewById(R.id.orchard_single_banner);
        ab.onDestory();
        super.onDestroy();
    }
    ...
    private class BookingTicket extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            try{
                ...
                res = sc.getURLString(ActivityMainInterface.Server_ip + "/app/booking_ticket", stringBuilder.toString());
                /*
                result code
                        0  fine
