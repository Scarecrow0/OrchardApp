...
public class ViewPagerAdsBanner extends ViewPager {

    public ViewPagerAdsBanner(Context context) {
        super(context);

    }

    public ViewPagerAdsBanner(Context context, AttributeSet attrs) {
        super(context,attrs);
    }
