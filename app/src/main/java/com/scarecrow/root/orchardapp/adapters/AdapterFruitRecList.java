...
import com.scarecrow.root.orchardapp.activties.ActivityFruitShop;
...
public class AdapterFruitRecList extends RecyclerView.Adapter<AdapterFruitRecList.ViewHolder> {
    ...
    public void setIsSpan(boolean res) {
        isSpan = res;
    }

    public void setIsForBroughtList(boolean b) {
        isForBroughtList = b;

    }

    public AdapterFruitRecList(Context context) {
        super();
        mContext = context;
    }
    ...
    private static Intent getIntent2FruitshopActivity(Context context, FruitsInfo clickedFruit) {
        ...
        Intent in = new Intent(context, ActivityFruitShop.class);
