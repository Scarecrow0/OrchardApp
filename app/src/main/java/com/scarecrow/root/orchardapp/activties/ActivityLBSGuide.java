...
import com.scarecrow.root.orchardapp.views.ViewMapDisplay;
...
public class ActivityLBSGuide extends AppCompatActivity {
    private static String TAG = "In LBS_Service";
    //声明AMapLocationClient类对象
    public AMapLocationClient mLocationClient = null;
    private ViewMapDisplay mapDisplay;
    ...
    public void onCreate(Bundle onSaveInstanceState) {
        ...
        mapDisplay = (ViewMapDisplay) findViewById(R.id.map_display);
        ...
        best_event_rv.setAdapter(new AdapterEventsRecList(getBaseContext()));
    ...
    private void processJSON(String jsonstr) {
        ...
        try {
            ...
            if (hasBestEvent.equals("yes")) {
                ...
                AdapterEventsRecList eventsRecListAdapter
                        = (AdapterEventsRecList) best_event_rv.getAdapter();
        ...
        protected String doInBackground(Double... params) {
            ...
            try {
                res_str = new ServerContacter()
                        .getURLString(ActivityMainInterface.Server_ip + "/app/lbs_request"
                                , "pos_x=" + params[0] + "&pos_y=" + params[1] + "&orchardnum=" + 1
                                        + "&username=" + ActivityMainInterface.logined_usr.username);
            } catch (Exception ee) {
                Log.d("ActivityLBSGuide", "doInBackground: error in lbs activity" + ee);
            }
            return res_str;
        }
